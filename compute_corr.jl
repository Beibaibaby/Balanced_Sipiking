...
labels = ["EPSC-EPSC", "Total-Total", "IPSC-IPSC"]
...
plot(labels, [correlation_values_non_event, correlation_values_event], label=["Non-event" "Event"],
     ...
     ylim=(0.0, 1.05),size=(600,500))  # Set the y-axis limits
