...
savefig(combined_plot, joinpath(directory_for_plot, "combined_plot.svg"))
savefig(combined_plot, joinpath(directory_for_plot, "combined_plot.pdf"))
savefig(combined_plot, joinpath(directory_for_plot, "combined_plot.png"))
