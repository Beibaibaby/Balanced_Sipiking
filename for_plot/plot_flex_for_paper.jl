...
savefig(p2, joinpath(directory_for_plot, "plot_flex.svg"))
savefig(p2, joinpath(directory_for_plot, "plot_flex.pdf"))
savefig(p2, joinpath(directory_for_plot, "plot_flex.png"))